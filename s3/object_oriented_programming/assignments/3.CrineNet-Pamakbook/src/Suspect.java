...
public class Suspect {
	...
	//Δημιουργία λιστών
	ArrayList<String> phoneBook = new ArrayList<String>(); //Λίστα αριθμών τηλεφώνων που χρησιμοποιεί ο ύποπτος
	...
	ArrayList<Suspect> suggestedPartners = new ArrayList<Suspect>(); // Λίστα με προτεινόμενους πιθανούς συνεργάτες
