...
5. **Υπεύθυνη δήλωση Συμμετεχόντων στη τελετή Ορκωμοσίας** , θεωρημένη μέσω [gov.gr](http://gov.gr/) (με τους κωδικούς taxisnet) και να την ανεβάσουν στη φόρμα. Εάν διαπιστωθεί εκκρεμότητα θα επικοινωνήσει η βιβλιοθήκη μαζί σας. Την βεβαίωση μη εκκρεμότητας με Εύδοξο και Βιβλιοθήκη παραλαμβάνει η γραμματεία
ηλεκτρονικά.
