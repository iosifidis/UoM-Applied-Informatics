...
Σύμφωνα με τον [κανονισμό σουδών 2022](https://www.uom.gr/assets/site/public/nodes/4317/14235-KANONISMOS_SPOUDON_TMIMA_EP-EKDOSI_2022.pdf){:target="_blank"} στην σελίδα 7, αναφέρει:
...
2. Εάν προσπαθήσετε να μπείτε στο [https://sis-portal.uom.gr/](https://sis-portal.uom.gr/){:target="_blank"} θα σας βγάλει μήνυμα:
...
Η ημερομηνία κατάθεσης των αιτήσεων και των δικαιολογητικών για τη συμμετοχή σας στην ορκωμοσία είναι έως την Παρασκευή 23-08-2024 και ώρα 24.00 στην [ΦΟΡΜΑ](https://forms.gle/ZnWFoyoxDnot8mmt6){:target="_blank"}  

Οι υποψήφιοι πτυχιούχοι που επιθυμούν να ορκιστούν θα πρέπει:
1. Να συμπληρώσουν την παραπάνω φόρμα.   
2. Να συμπληρώσουν την [αίτηση ορκωμοσίας του Τμήματος](https://www.uom.gr/assets/site/public/nodes/3661/7609-GradApplication_2020.docx){:target="_blank"} και κατόπιν να την ανεβάσουν στη φόρμα.   
...
ή [υπεύθυνη δήλωση απώλειας των παραπάνω](https://www.uom.gr/assets/site/public/nodes/3661/7285-GradDeclaration.docx){:target="_blank"}, θεωρημένη μέσω [gov.gr](http://gov.gr/){:target="_blank"} (με τους κωδικούς taxisnet) και να την ανεβάσουν στη φόρμα.

4. Να υποβάλουν [ηλεκτρονική αίτηση στην βιβλιοθήκη για έλεγχο εκκρεμοτήτων](http://www.lib.uom.gr/index.php/el/aitisi-elegxou-mi-ekkremotitas?view=form){:target="_blank"} που αφορούν σε Εύδοξο και βιβλιοθήκη.

5. **Υπεύθυνη δήλωση Συμμετεχόντων στη τελετή Ορκωμοσίας** , θεωρημένη μέσω [gov.gr](http://gov.gr/){:target="_blank"} (με τους κωδικούς taxisnet) και να την ανεβάσουν στη φόρμα. Εάν διαπιστωθεί εκκρεμότητα θα επικοινωνήσει η βιβλιοθήκη μαζί σας. Την βεβαίωση μη εκκρεμότητας με Εύδοξο και Βιβλιοθήκη παραλαμβάνει η γραμματεία
ηλεκτρονικά.
...
*Η κατάθεση των αιτήσεων μέσω της [ΦΟΡΜΑΣ](https://forms.gle/ZnWFoyoxDnot8mmt6){:target="_blank"} πραγματοποιείται αποκλειστικά με χρήση των ιδρυματικών λογαριασμών (xxx@uom.edu.gr) και μόνον από τους-τις υποψήφιους-ες πτυχιούχους-ες.
...
1. Πρέπει να συμπληρώσετε την [Υπεύθυνη δήλωση αδυναμίας επιστροφής αποδεικτικών φοιτητικής ιδιότητας](https://www.uom.gr/assets/site/public/nodes/3661/7285-GradDeclaration.docx){:target="_blank"} (θα την βρείτε και στο αποθετήριο). Εδώ ουσιαστικά συμπληρώνετε ότι δεν έχετε παραλάβει το βιβλιάριο σπουδών και βιβλιάριο υγείας. Επίσης ανάλογα εάν δεν έχετε κάρτα σίτισης, το συμπληρώνετε και αυτό.    

2. Πρέπει να συμπληρώσετε την [Αίτηση συμμετοχής στην τελετή αποφοίτησης](https://www.uom.gr/assets/site/public/nodes/3661/7609-GradApplication_2020.docx){:target="_blank"} (θα την βρείτε και στο αποθετήριο). Εδώ ουσιαστικά αναφέρει και τα σημαντικά δικαιολογητικά που πρέπει να υποβάλετε. Συγκεκριμένα αναφέρει:
...
Επιπλέον δηλώνω ότι έχω υποβάλει Ηλεκτρονική Αίτηση  [Ελέγχου εκκρεμοτήτων με ΕΥΔΟΞΟ και Βιβλιοθήκη](https://www.lib.uom.gr/index.php/el/aitisi-elegxou-mi-ekkremotitas?view=form){:target="_blank"} , γνωρίζοντας ότι η υποβολή της είναι υποχρεωτική και ότι η σχετική βεβαίωση εκδίδεται ενδοϋπηρεσιακά.
...
ΜΗΝ ΞΕΧΑΣΕΤΕ ΝΑ ΖΗΤΗΣΕΤΕ ΤΗΝ ΒΕΒΑΙΩΣΗ [ΠΑΙΔΑΓΩΓΙΚΗΣ ΔΙΔΑΚΤΙΚΗΣ ΕΠΑΡΚΕΙΑΣ](https://www.uom.gr/dai/programma-paidagogikhs-kai-didaktikhs-eparkeias){:target="_blank"}. ΕΑΝ ΕΧΕΤΕ ΤΕΛΕΙΩΣΕΙ ΤΑ ΜΑΘΗΜΑΤΑ ΚΑΙ ΕΧΕΤΕ ΑΚΟΜΑ ΠΡΟΣΒΑΣΗ ΣΤΟ [SIS-PORTAL](https://sis-portal.uom.gr/) ΜΠΟΡΕΙΤΕ ΝΑ ΖΗΤΗΣΕΤΕ.

### Φόρμα Μητρώου Αποφοίτων

Όταν συμπληρώνετε την φόρμα, αναφέρει και να συμπληρώστε την [φόρμα μητρώου αποφοίτων](https://www.uom.gr/alumni/forma-mhtroou-apofoiton){:target="_blank"}.

## Επαγγελματικά δικαιώματα

Σύμφωνα με τον οδηγό [σπουδών 2023-2024](https://drive.google.com/file/d/1UTjhWPKKxKA_x0q9BpdRuZEFUWgQfYhU/view){:target="_blank"}, υπάρχει 
