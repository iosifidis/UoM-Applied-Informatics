...
ή [υπεύθυνη δήλωση απώλειας των παραπάνω](https://www.uom.gr/assets/site/public/nodes/3661/7285-GradDeclaration.docx), θεωρημένη μέσω [gov.gr](https://www.gov.gr/ipiresies/polites-kai-kathemerinoteta/psephiaka-eggrapha-gov-gr/psephiake-bebaiose-eggraphou) (με τους κωδικούς taxisnet) και να την ανεβάσουν στη φόρμα.
...
5. **Υπεύθυνη δήλωση Συμμετεχόντων στη τελετή Ορκωμοσίας** , θεωρημένη μέσω [gov.gr](https://www.gov.gr/ipiresies/polites-kai-kathemerinoteta/psephiaka-eggrapha-gov-gr/ekdose-upeuthunes-deloses) (με τους κωδικούς taxisnet) και να την ανεβάσουν στη φόρμα. 

--------------------------------------------------------------
ΠΡΟΤΕΙΝΟΜΕΝΟ ΚΕΙΜΕΝΟ (σύμφωνα με την φόρμα):    

1. Επιθυμώ να παρευρεθούν στην τελετή ορκωμοσίας του τμήματος εφαρμοσμένης πληροφορική του πανεπιστημίου Μακεδονίας που θα γίνει 23/9, τα παρακάτω 4 άτομα:   
* Όνομα επίθετο του πατέρα με Αριθμό Ταυτότητας ...   
* Όνομα επίθετο του πατέρα με Αριθμό Ταυτότητας ...   
* Όνομα επίθετο του πατέρα με Αριθμό Ταυτότητας ...   
* Όνομα επίθετο του πατέρα με Αριθμό Ταυτότητας ...   

2. Δηλώνω ότι ούτε ο ίδιος ούτε κανένας από τα άτομα που θα παραβρεθούν στην τελετή αποφοίτησης δεν θα φέρει μαζί του ή δεν θα κάνει χρήση κομφετί, ηχητικού οργάνου, κροτίδας, βεγγαλικού, καπνογόνου κ.ά., για όσο διάστημα θα βρίσκεται στους χώρους του Πανεπιστημίου Μακεδονίας, είτε εσωτερικά του κτιρίου είτε σε όλον τον προαύλιο χώρο και περιμετρικά του κτιριακού συγκροτήματος.
--------------------------------------------------------------
...
Τα επαγγελματικά δικαιώματα των αποφοίτων του Τμήματος περιγράφονται στο σχετικό Προεδρικό Διάταγμα που δημοσιεύτηκε στο **ΦΕΚ A'/58/8.4.2009**. Οι απόφοιτοι και των δύο κατευθύνσεων του Τμήματος έχουν δικαίωμα εγγραφής στο [Οικονομικό Επιμελητήριο](https://oe-e.gr/προϋποθέσεις-εγγραφής-μέλους/). Ειδικότερα, οι απόφοιτοι του Τμήματος μπορούν να εργαστούν ως ελεύθεροι επαγγελματίες και στελέχη ιδιωτικών επιχειρήσεων, [εκπαιδευτικοί στη δημόσια και ιδιωτική εκπαίδευση](https://www.youtube.com/watch?v=Cr5d0Zb6CD4) και ως στελέχη του δημόσιου τομέα.
