...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickPickBrand(View v){
        // Δημιουργώ ένα νέο αντικείμενο
        CarPickerSelector cps = new CarPickerSelector();

        // Επιλεγμένο αντικείμενο από την λίστα
        Spinner sp = findViewById(R.id.brandList);

        // Από το spinner παίρνω το επιλεγμένο αντικείμενο
        ...
        if (mList.size() == 0){
            ...
            myToast.show();
                ...
                // Μέθοδος που δέχεται το radiobutton και την λίστα που θέλουμε να προςσθέσουμε. Την φτιάχνουμε στο main actiiviti
