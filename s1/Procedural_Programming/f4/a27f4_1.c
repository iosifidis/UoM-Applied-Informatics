...
long encode(long code)
{
    ...
    while (n!=0)
    {
    code *= 10; // Πολλαπλασίασε με το 10 τον αρχικό κωδικό και καταχώρησέ τον
    n /= 10; // Διαίρεσε τα ψηφία ελέγχου με το 10 και αποθήκευσέ τα
    }
    // Με αυτόν τον τρόπο ενώνονται πολλά ψηφία μαζί. Εδώ ζητούσε ο δεύτερος κωδικός έχει 2 ψηφία.
    return code + temp; // Πρόσθεσε τον αρχικό κωδικό (πολλαπλασιασμένο με όσα δεκαδικά έχει 
