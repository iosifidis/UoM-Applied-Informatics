/*  Αρχείο: a20f3.c
    ...
    Γράψτε ένα πρόγραμμα που να διαβάζει μια σειρά από ηλικίες ανθρώπων (ακολουθία αριθμών int που εισάγεται 
    από το χρήστη) και να βρίσκει την μικρότερη και τη μεγαλύτερη ηλικία. Το πρόγραμμα θα συνεχίζει να 
    διαβάζει ηλικίες μέχρι να δοθεί ως ηλικία ο αριθμός -1
    */
